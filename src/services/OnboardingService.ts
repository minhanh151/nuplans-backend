...
export class OnboardingService {
    ...
    public async saveOnboarding(user: User, data: any) {
        ...
        try {
            const profileRepo = queryRunner.manager.getRepository(Profile);
            const skillProfileRepo = queryRunner.manager.getRepository(SkillProfile);
            const skillRepo = queryRunner.manager.getRepository(SkillProfileSkill);
    ...
    public async getProfile(user: User) {
        ...
        return await profileRepo.findOne({ where: { userId: user.id } });
    }
}
